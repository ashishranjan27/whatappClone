...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //remove the top of bar "toolbar"
//        getSupportActionBar().hide();

        progressDialog = new ProgressDialog(SignInActivity.this);
        progressDialog.setTitle("Login the account");
        progressDialog.setMessage("Login to the account");
    ...
    //onActivityResult used for when on returning data from 2nd to 1st screen
    //so it's basically due to startActivityForResult which is just above in sigIn() method
